 ...
 */
package com.demo.javafxexample.apps.bkcourse.tvlistapp.s2.start;
...
public class TVListApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader( TVListApp.class.getResource("/s2/start/TVList.fxml") );
        ...
        scene.getStylesheets().add("s2/start/tvlist.css");
