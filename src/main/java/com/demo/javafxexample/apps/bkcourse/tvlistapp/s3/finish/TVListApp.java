 ...
 */
package com.demo.javafxexample.apps.bkcourse.tvlistapp.s3.finish;
...
public class TVListApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader( TVListApp.class.getResource("/s3/finish/TVList.fxml") );
        ...
        scene.getStylesheets().add("s3/finish/tvlist.css");
