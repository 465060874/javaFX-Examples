 ...
 */
package com.demo.javafxexample.apps.bkcourse.tvlistapp.s2.finish;
...
public class TVListApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader( TVListApp.class.getResource("/s2/finish/TVList.fxml") );
        ...
        scene.getStylesheets().add("s2/finish/tvlist.css");
