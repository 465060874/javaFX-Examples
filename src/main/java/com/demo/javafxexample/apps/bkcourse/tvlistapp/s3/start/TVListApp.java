 ...
 */
package com.demo.javafxexample.apps.bkcourse.tvlistapp.s3.start;
...
public class TVListApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader( TVListApp.class.getResource("/s3/start/TVList.fxml") );
        ...
        scene.getStylesheets().add("s3/start/tvlist.css");
